...
module.exports = async function (context, req) {
    context.log('Approve endpoint called');
    ...
    try {
        ...
        if (!clientFolder) {
            context.res = {
                ...
                body: '<h1>Invalid approval link</h1><p>Missing client folder parameter.</p>'
            };
            return;
        }
        ...
        context.res = {
            ...
            body: `
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Approval Error - IBV Gold</title>
                    <style>
                        body {
                            font-family: 'Segoe UI', Arial, sans-serif;
                            display: flex;
                ...
                <body>
                    <div class="error-box">
                        ...
                        <p style="font-size: 14px; color: #999;">Please contact the system administrator.</p>
                    </div>
                </body>
                </html>
            `
